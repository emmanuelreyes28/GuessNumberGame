...
// Minor typos fixed by Norman Jacobson, August 2012
//
// This class implements the "engine" for the "guess a number" game.
// The engine is in charge of choosing a random "target number," comparing 
// the user's guesses to the target number, and responding accordingly.
//
...
// programming is to write relatively simple components that do single, 
// targeted jobs and that know as little as possible about one another.  
// For instance, GuessNumberGame doesn't rely on the fact that this
